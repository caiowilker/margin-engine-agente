...
$checks = @(
    ...
    @{ Path = "dist\app\print\winProcessKill.js"; Hint = "winProcessKill (RAW Win32)" },
    @{ Path = "dist\app\print\acbrPosWorkerPool.js"; Hint = "PosPrinter worker pool" },
    @{ Path = "dist\app\print\workers\acbrPosWorker.js"; Hint = "PosPrinter worker" },
    @{ Path = "dist\app\config\printEnvSchema.js"; Hint = "printEnvSchema SSOT" },
    @{ Path = "dist\app\runtime\physicalResourceLock.js"; Hint = "physicalResourceLock" },
