...
const CATALOGO = {
  ...
  fiscalCallbackWorkerMs: {
    env: "FISCAL_CALLBACK_WORKER_MS",
    tipo: "number",
    default: 800,
    min: 200,
    max: 10000,
    grupo: "fiscal",
    label: "Worker callback backend (ms)",
  },
  fiscalPdfWorkerMs: {
    env: "FISCAL_PDF_WORKER_MS",
    tipo: "number",
    default: 2000,
    min: 500,
    max: 30000,
    grupo: "fiscal",
    label: "Worker GERAR_PDF (ms)",
  },
  fiscalJobStaleMin: {
    env: "FISCAL_JOB_STALE_MIN",
    tipo: "number",
    default: 15,
    min: 2,
    max: 120,
    grupo: "fiscal",
    label: "Minutos até job PROCESSANDO órfão",
  },
  fiscalRateLimitMin: {
  ...
  printerDrawer: {
    ...
    grupo: "impressora",
    label:
      "Tem gaveta de dinheiro — abre no dinheiro, abertura/sangria e teste (Não = só impressora)",
  },
  printerModel: {
    env: "PRINTER_MODEL",
    tipo: "string",
